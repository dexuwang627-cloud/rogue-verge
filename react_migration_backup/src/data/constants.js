...
export const RELICS_DATA = [
    ...
    },
    {
        ...
        price: 'Sold Out',
        description: {
            'zh-TW': '觀察者視網膜數據的實體化織物。每一隻眼睛都記錄著一個系統錯誤。',
            'en': 'Physicalized fabric of observer retinal data. Each eye records a system error.'
        },
        images: ['/image/eyes.png', '/image/sigilism.png']
    },
    {
        id: 3,
        ...
        price: 'Coming Soon',
        description: { 'zh-TW': '賽博圖騰的核心矩陣。未經授權的存取將導致視覺神經過載。', 'en': 'Core matrix of the Cyber Sigil. Unauthorized access will cause optic nerve overload.' },
    ...
    },
    {
        ...
        price: 'Coming Soon',
        description: { 'zh-TW': '數位廢墟中的殘留物。', 'en': 'Residue from digital ruins.' },
        images: ['/image/sigilism.png']
    },
    {
        id: 6,
